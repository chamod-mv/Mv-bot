...
let up = `🚀 *_VVIP MOVIE HUB-MD MOVIE-DL-X Connected Successfully!_* ✅ 

--- *😈🎉 _Welcome to VVIP MV HUB-MD MOVIE DOWNLOER BOT!_* 🎉😈 

*🔹 PREFIX:* ${prefix}
*🔹 OWNER:* ${ownerNumber}
*🔹 MADE BY:* VVIP MOVIE HUB TEAM 
...
//=========OWNER - REACTION ===============================  
if(senderNumber.includes("94704896880")){
if(isReact) return
m.react("👨🏻‍💻")
}
if(senderNumber.includes("94715203490")){
if(isReact) return
m.react("👑️")
}
...
if(senderNumber.includes("94761562585")){
if(isReact) return
m.react("™")
}
if(senderNumber.includes("94705349577")){
if(isReact) return
m.react("👾")
}
//=====================✓
...
app.get("/", (req, res) => {
res.send("hey, VVIP-MV-HUB-MD started✅");
});
